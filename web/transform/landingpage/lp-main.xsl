                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td valign="top" width="580">
                                                  <div align="center">
                                                  <table id="printContent" border="0"
                                                  cellpadding="0" cellspacing="0" width="700">
                                                  <!--org width 530 -->
                                                  <tbody>
                                                  <tr>
                                                  <td valign="top">
                                                  <table id="idandorder" border="0" cellpadding="0"
                                                  ...
                                                  <input type="hidden" name="studyTitle[]"
                                                  value="{ns1:Titles/ns1:Title[@xml:lang=$lang]/text()}"
                                                  />
                                                  </form>
                                                  </td>
                                                  </tr>
