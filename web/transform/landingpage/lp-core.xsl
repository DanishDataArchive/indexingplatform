        ...
        <div xmlns:foaf="http://xmlns.com/foaf/0.1/" xmlns:dcterms="http://purl.org/dc/terms/"
            ...
            <xsl:for-each select="ns1:PrincipalInvestigators/ns1:PrincipalInvestigator">
                <div itemscope="itemscope" itemtype="http://schema.org/Person">
                    ...
                    </span>, <xsl:value-of select="ns1:Person/ns1:Affiliation/ns1:AffiliationName"/>
                </div>
            </xsl:for-each>
            ...
            <p class="lp">
                ...
                <xsl:if
                    test="ns1:Methodology/ns1:TimeMethod/ns1:Description[@xml:lang=$lang]/text()">, <em>
                        <xsl:value-of
            ...
            <p class="lp">
                ...
                <xsl:if test="ns1:Methodology/ns1:TestType/ns1:Description[@xml:lang=$lang]/text()"
                    >, <em>
                        <xsl:value-of
