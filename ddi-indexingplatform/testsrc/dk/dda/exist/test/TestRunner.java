...
public abstract class TestRunner {
    ...
    public void run() {
        ...
        try {
            ...
            Source query = new FileSource(new File("testsrc/xquery/runTests.xql"), "UTF-8", false);
            for (File file : files) {
...
//        rootCollection =
//                DatabaseManager.getCollection("xmldb:exist://localhost:8080/exist/xmlrpc/db/dda", "admin", null);
    }
